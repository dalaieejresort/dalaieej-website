...
const COPY: Record<"en" | "mn", Record<CopyKey, string>> = {
  en: {
    eyebrow: "Your refuge in the wild",
    title: "Cabins & Camps",
    ...
    tagline1: "A refuge at the edge of the world.",
    tagline2: "Where the forest meets the water.",
    aboutCta: "More About Us",
    experiencesEyebrow: "Paired with your stay",
    experiencesHeading: "Relax & restore",
    spaTitle: "Sauna & Jacuzzi",
    spaDesc:
      "Wood-fired heat and deep waters. A place to unwind under the stars after a long day in the forest.",
  ...
  mn: {
    ...
    tagline1: "Хөвсгөлийн гүн цэнгэг мандал,",
    tagline2: "Хөвч тайгын анир чимээгүйд.",
    ...
    spaDesc:
      "Ил галын илч, гүн цэнгэг ус. Ойд өнгөрүүлсэн урт өдрийн дараа оддын дор алжаалаа тайлах орон зай.",
