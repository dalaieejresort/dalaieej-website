...
import { Copy, Check, ChevronDown, ChevronUp, Smartphone, QrCode, Loader2 } from "lucide-react";
...
function PaymentContent() {
  ...
  useEffect(() => {
    if (fromCheckout && bookingId && amount && !hasAutoGenerated.current && !qrCode) {
      hasAutoGenerated.current = true;
      setAutoGenerating(true);
      generateQRAutomatic(bookingId, amount);
    }
  }, [fromCheckout, bookingId, amount, qrCode]);
  ...
  if (autoGenerating || (fromCheckout && loading && !qrCode)) {
    return (
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-12 border border-[#F5F5DC]/20 text-center">
            ...
            <p className="text-[#F5F5DC] font-serif text-xl mb-2">
              {currentLocale === 'mn' ? 'Төлбөрийн QR үүсгэж байна...' : 'Generating Payment QR...'}
            </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-[#F5F5DC]/20">
            {fromCheckout && error ? (
              <div className="space-y-5">
                ...
                <button
                  onClick={() => generateQRAutomatic(bookingId, amount)}
